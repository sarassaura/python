'''
Uma montadora de discos voadores possui filiais em diversos planetas. 
Recentemente, a empresa enviou um comunicado a todos os seus clientes 
sobre a necessidade de realização de revisão em alguns discos voadores, 
...
Escreva um programa que leia o ano de produção do disco voador, 
o código do motor principal, a distância percorrida pelo disco (em anos-luz) 
e imprima "SIM" (se o disco requer revisão) ou 
"NAO" (se o disco não requer revisão no momento).
...
if ano >= 1901 and ano <= 2000 and (codigo == 100 or codigo == 101):
    print("SIM")
elif ano >= 2001 and ano <= 2020 and distancia > 5000:
    print("SIM")
elif ano == 2021 and (codigo == 200 or codigo == 201) and distancia > 200:
    print("SIM")
else:
    print("NAO")