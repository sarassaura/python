...
então deverá imprimir o primeiro 
formatado com nenhuma casa decimal, 
o segundo com duas casas e o terceiro 
com três casas, seguindo o mesmo 
estilo da saída de exemplo.
...
print("Primeiro numero = {:d}".format(int(x)))
print("{:.2f} eh o segundo numero".format(y))
print("Finalmente {:.3f} eh o terceiro numero".format(z))